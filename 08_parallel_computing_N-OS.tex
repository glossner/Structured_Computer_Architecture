...
\begin{table}[h]
	...
	\begin{tabular}{|l|l|} \hline  % Your table
        ...
        AND(Vi,Vj,Vk) & bitwise AND of vectors Vj and Vk in vector Vi  \\ \hline
        OR(Vi,Vj,Vk) & bitwise OR of vectors Vj and Vk in vector Vi  \\ \hline
        XOR(Vi,Vj,Vk) & bitwise XOR of vectors Vj and Vk in vector Vi  \\ \hline
...
-----------------------------------------------
        ...
        SHIFTRIGHT(n+1,n,0)
        SHHIFTLEFT(n+2,i,0)
        SHHIFTLEFT(n+3,n+2,0)
        MAPOP(i,n,n+1,n+2,n+3,...)
-----------------------------------------------
\end{verbatim}
}
