...
| 1st Global Loop | N-loop & 1st global loop many-cell systems.| Controller, Map Array, Reduce loop               | MapReduce Parallel Accelerator                |
| 2nd Global Loop | N-loop & 2nd global loop many-cell systems.| Controller, Map Array, Reduce loop, Scan loop    | MapScanReduce Parallel Accelerator            |
...
All text content is copyright © 2025-2026 CC-BY-NC-ND 4.0 by John Glossner and Gheorghe M. Ştefan 
licensed under a Creative Commons Attribution-NonCommercial-NoDerivatives 4.0 International License
(CC BY-NC-ND 4.0). https://creativecommons.org/licenses/by-nc-nd/4.0/deed.en

Upon our deaths, the text copyright shall convert to © 2025-2026 by John Glossner and Gheorghe M. Ştefan
...
### Chisel (Scala) Code License - Solderpad Hardware Licence v2.1
