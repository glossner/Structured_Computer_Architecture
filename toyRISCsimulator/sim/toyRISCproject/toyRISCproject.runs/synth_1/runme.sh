...
HD_PWD='C:/george/carti/COMPUTER ARCHITECTURE/toyRISCsimulator/sim/toyRISCproject/toyRISCproject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log toyRISC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source toyRISC.tcl
