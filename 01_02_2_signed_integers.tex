...
Example
For a 4-bit one's complement representation:
\[
...
%************************************************************
Addition Example (4-bit two's complement):
\[
3 + (-2)
\]
In two's complement:
...
Subtraction Example (4-bit two's complement):
\[
-3 - 2
\]
In two's complement:
...
%************************************************************
\subsubsection{Comparisons with Excess-\( k \) Representation}
%************************************************************
...
%************************************************************
\subsubsection{Addition with Excess-\( k \) Representation}
%************************************************************
...
%************************************************************
\subsubsection{Subtraction with Excess-\( k \) Representation}
%************************************************************
...
%*********************************
\subsubsection{Addition using BCD}
%**********************************
Encoding Example:
\[
...
%*********************************
\subsubsection{Subtraction in BCD}
%*********************************
We want to compute:
\[
75 - 46 = 29
...
---
 ...
 Verification:
Convert \( 0010 \; 1001 \) back to decimal:
\[
2 \times 10 + 9 = 29
\]
...
%************************************************************
 ...
 Scenario:
A financial application needs to add \$1.10 and \$0.30, which should result in \$1.40. The values are represented in both **binary floating-point** and **BCD** to illustrate the differences in accuracy \cite{goldberg1991}.

---

\subsubsection{Floating-Point Representation}

Floating-point uses binary fractions to approximate decimal values. Let's encode \$1.10 and \$0.30 as 32-bit IEEE 754 single-precision floating-point numbers.
...
1. **Representation**:
   - For \$1.10:
     ...
     \]
     Approximated in floating-point as:
     \[
...
3. **Result**:
   The floating-point result is approximately:
   \[
...
In BCD, each decimal digit is encoded precisely without approximation. Let's represent \$1.10 and \$0.30 in BCD.
...
\textbf{1. Sign-and-Logarithm Representation} \\
...
\textbf{3. Offset Binary (Biased Binary)} \\
...
\textbf{4. Base-2 Signed-Digit (SD) Representation} \\
...
\textbf{6. Segmented Representations} \\
...
\textbf{7. Residue Number System (RNS)} \\
