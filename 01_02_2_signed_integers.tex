...
\begin{enumerate}
    \item \textbf{Compute \( 100 + 50 - 90 \):}
    \begin{enumerate}
        \item \textbf{Step 1: Compute \( 100 + 50 \):}
        ...
        The true sum in \( \mathbb{Z} \) is \( 100 + 50 - 90 = 60 \), which is correctly represented within the range of 2's complement. The intermediate overflows did not affect the correctness of the final result due to modular arithmetic.
    \end{enumerate}
\end{enumerate}
