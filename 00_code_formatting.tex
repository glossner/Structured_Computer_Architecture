...
\newcommand{\mystylecaptionpos}{b}                        % Caption position below
\newcommand{\mystyleshowstringspaces}{false}              % Do not show spaces in strings
...
\lstdefinestyle{baseStyle}{
    ...
    captionpos=\mystylecaptionpos,                       
    showstringspaces=\mystyleshowstringspaces,             
...
\DeclareRobustCommand{\includecode}[2]{%
    \ifthenelse{\boolean{chiselversion}}{%
        \includechiselcode[caption={#2 Code (Chisel)},label={lst:chisel_\string#2}]{#1/RTL/Chisel/src/main/scala/scabook/#2.scala}%
    }{}%
    \ifthenelse{\boolean{verilogversion}}{%
        \includeverilogcode[caption={#2 Code (Verilog)},label={lst:verilog_\string#2}]{#1/RTL/Verilog/src/#2.sv}%
    }{}%
}
