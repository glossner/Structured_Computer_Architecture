...
%#1: Base path (e.g. myproject)
%#2: Code name (e.g. mycode)
%#3: Verilog first line
%#4: Verilog last line
%#5: Chisel first line
%#6: Chisel last line
%\includecode{myproject}{mycode}{10}{30}{40}{60}


\NewDocumentCommand{\includecode}{m m O{1} O{99999} O{1} O{99999}}{%
  % #1 = project path
  % #2 = code name
  % #3 = verilog first line (default 1)
  % #4 = verilog last line (default 99999)
  % #5 = chisel first line (default 1)
  % #6 = chisel last line (default 99999)

  \ifthenelse{\boolean{chiselversion}}{%
    \includechiselcode[{caption={#2 Code (Chisel)},label={lst:chisel_\string#2}, firstline=#5, firstnumber=#5, lastline=#6}]{#1/RTL/Chisel/src/main/scala/scabook/#2.scala}%
  }{}%

  \ifthenelse{\boolean{verilogversion}}{%
    \includeverilogcode[{firstline=#3, firstnumber=#3, lastline=#4, caption={#2 Code (Verilog)}, label={lst:verilog_\string#2}}]{#1/RTL/Verilog/src/#2.sv}%
  }{}%
}
