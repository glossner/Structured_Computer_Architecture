...
\section{Architecture vs. Organization}
...
controls, the logical design, and the physical implementation.} \cite{Amdahl}
\end{quote}
...
between the software engineer  and hardware engineer. We will list and comment further on the main characteristics of an ISA \cite{Patterson4}:
\begin{itemize}
    \item Class of ISA
        \begin{itemize}
