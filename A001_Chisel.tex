...
sudo apt install sbt
    ...
    \item \textbf{Create a New Chisel Project:} \\
    Use the Chisel template to set up a new project:
    \begin{bashcode}
sbt new chisel3/chisel3.g8
    \end{bashcode}
    Follow the prompts to configure your new Chisel project.

    \item \textbf{Build and Run Your Chisel Project:} \\
    Navigate to your project's directory and use sbt to compile and run it:
    \begin{bashcode}
cd your-chisel-project && sbt compile && sbt test
    \end{bashcode}
\end{enumerate}
