...
\includechiselcode[caption={Waveform Generator Code (Chisel)}, label={lst:chisel_waveformgenerator}]{RTL/Chisel/src/main/scala/scabook/waveFormGenerator.scala}

The testbench for the code is:
\includechiselcode[caption={Waveform Generator Testbench Code (Chisel)}, label={lst:chisel_waveformgeneratortestbench}]{RTL/Chisel/src/test/scala/scabook/waveFormGeneratorSpec.scala}
...
This will produce
\includeverilogcode[caption={Clean SystemVerilog Code Produced by Chisel}, label={lst:chisel_waveformgeneratorcleanverilog}]{RTL/Chisel/generated_verilog_clean/WaveFormGenerator.sv}
...
\includeverilogcode[caption={Annotated SystemVerilog Code Produced by Chisel}, label={lst:chisel_waveformgeneratorannotatedverilog}]{RTL/Chisel/generated_verilog_annotated/WaveFormGenerator.sv}

%***********************************************
\subsection{Verilator C++ Test Driver}
%***********************************************
Create a Verilator C++ test driver. It is in Chisel/verilator\_testbench
\includecppcode[caption={Verilator Testbench for WaveFormGenerator}, label={lst:verilator_waveformgenerator_testbench}]{RTL/verilator_testbench/WaveFormGenerator_testbench.cpp}
...
%********************************************
\section{Comparison of Vivado and Verilator}
%********************************************
...
\section*{When to Use Vivado vs. Verilator}
...
\section*{SystemVerilog Testbench}
