...
// SEARCH INSTRUCTIONS
`define search  5'b01101 // act[i]<=(b[i]&acc[i]=op)?act[i]:
                         //         act[i]+1
`define csearch	5'b01110 // act[i]<=(b[i-1]&acc[i]=op)?0:act[i]+1
`define insert  5'b01111 // insert in the first active cell in sr
...
`define elsew   5'b00010 // act[i]<=(act[i]=0)?1:(act[i]=1)?0:
                         //         act[i]
