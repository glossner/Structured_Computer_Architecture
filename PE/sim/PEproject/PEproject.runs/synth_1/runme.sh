...
HD_PWD='C:/george/carti/COMPUTER_ARCHITECTURE_NEXT/PE/sim/PEproject/PEproject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log elementaryProcessor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source elementaryProcessor.tcl
