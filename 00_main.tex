...
% - Code listings is fragile and complex
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\cftsetindents{paragraph}{12em}{3em} 

% Table of Contents spacing for Table tag
\setlength{\cftbeforeloftitleskip}{0pt}     % Default spacing before the title
\setlength{\cftafterloftitleskip}{0pt}      % Default spacing after the title
\setlength{\cftbeforeloftitleskip}{1em}   

\renewcommand{\lstlistlistingname}{Code Listings}
% Register List of Listings with tocloft and customize spacing
\makeatletter
% Define lengths for List of Listings title
\newlength{\cftbeforelstlistlistingtitleskip}
\newlength{\cftafterlstlistlistingtitleskip}
\setlength{\cftbeforelstlistlistingtitleskip}{1em} % Space before title
\setlength{\cftafterlstlistlistingtitleskip}{0.5em} % Space after title

% Define lengths for List of Listings chapter entries
\newlength{\cftbeforelstlistingchapterskip}
\newlength{\cftafterlstlistingchapterskip}
\setlength{\cftbeforelstlistingchapterskip}{1em} % Space before each chapter
\setlength{\cftafterlstlistingchapterskip}{0.5em} % Space after each chapter

% Patch \lstlistoflistings for title spacing
\patchcmd{\lstlistoflistings}
  {\@starttoc{lol}}
  {\vspace{\cftbeforelstlistlistingtitleskip}\@starttoc{lol}\vspace{\cftafterlstlistlistingtitleskip}}
  {}{}

% Add spacing for chapters in List of Listings
% This requires custom chapter formatting within the List of Listings
\renewcommand{\l@chapter}[2]{%
  \ifnum \c@tocdepth >-2\relax
    \addvspace{\cftbeforelstlistingchapterskip}% Space before chapter
    \@dottedtocline{0}{1.5em}{2.3em}{\bfseries #1}{#2}%
    \addvspace{\cftafterlstlistingchapterskip}% Space after chapter
  \fi}
\makeatother
