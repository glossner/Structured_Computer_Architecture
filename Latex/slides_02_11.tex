...
% subsection 1: Introduction to 3-OS
\subsection{Introduction to Third-Order Systems}
...
% subsection 2: Counter-Expanded Automata
...
% subsection 3: Elementary Processor Architecture
\subsection{Elementary Processor Architecture}
...
\begin{column}{0.4\textwidth}
\begin{center}
\includegraphics[width=\textwidth]{Latex/Images/elementaryProcessor.png}
\end{center}
\vspace{0.2cm}
\begin{center}
...
\begin{column}{0.4\textwidth}
\begin{center}
\includegraphics[width=\textwidth]{Latex/Images/peRALU.png}
\end{center}
...
\begin{column}{0.4\textwidth}
\begin{center}
\includegraphics[width=\textwidth]{Latex/Images/epCROM.png}
\end{center}
\concept{Characteristics}:
\begin{itemize}
...
% subsection 4: Register File Design
...
\begin{column}{0.4\textwidth}
\begin{center}
\includegraphics[width=\textwidth]{Latex/Images/epRegFile.png}
\end{center}
\concept{Operation}:
\begin{itemize}
...
\begin{column}{0.4\textwidth}
\begin{center}
\includegraphics[width=\textwidth]{Latex/Images/epALU.png}
\end{center}
...
% subsection 6: Control ROM and Micro-programming
\subsection{Control ROM and Micro-programming}
...
\begin{column}{0.4\textwidth}
\begin{center}
\includegraphics[width=\textwidth]{Latex/Images/epROM.png}
\end{center}
\concept{Characteristics}:
\begin{itemize}
...
% subsection 7: Processor Operation
\subsection{Elementary Processor Operation}
...
% subsection 8: Programming Model
\subsection{Programming Model and Applications}
...
% subsection 9: Design Considerations
