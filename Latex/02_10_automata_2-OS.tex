...
single chip more than $10^{10}$ components, the size of the circuits we design 
...
lay-out, of fan-out and of speed are not captured by this definition.
...
possibility to write the testable program expressing our desire.
...
describe} simple enough (because we can't
...
The code generator is tested using the  module for  Listing \ref{lst:A10_simulator.sv}.
...
The code {\tt func} selects the  functions defined in Listing \ref{lst:A10_defineRALU.vh}.
