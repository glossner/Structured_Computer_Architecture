...
\includeverilogcode[caption={toyRISC ISA.  File: 0\_DEFINES.vh  (SystemVerilog)}, 
...
\includeverilogcode[caption={A sample of the binary code generator for toyRISC processor.  File: RISCcodeGenerator.sv  (SystemVerilog)}, 
                    label={lst:RISCcodeGenerator}, 
                    firstline=1, 
                    firstnumber=1, 
                    lastline=160]
                    {\verilogSourceDir/A11_RISCcodeGenerator.sv}
