...
\addcontentsline{toc}{section}{Chisel Scala Code License - BSD 3-clause}
...
\begin{tabular}{|>{\centering\arraybackslash}m{2.5cm} | >{\centering\arraybackslash}m{4.2cm} | >{\centering\arraybackslash}m{3.7cm} | >{\centering\arraybackslash}m{3.8cm}|}
\hline
...
3rd-Order & Three-loops processing units. & ALU, control units, registers. & Elementary processor, Simple microprocessor. \\ \hline
...
nth-Order High-Order 0  & N-loop, no global loop many-cell systems. & Controller, Map Array & Map Parallel Accelerator  \\ \hline

nth-Order 1st-High Order & N-loop \&  1st global loop many-cell systems. & Controller, Map Array, Reduce loop & MapReduce Parallel Accelerator  \\ \hline

nth-Order 2nd-High Order & N-loop \& 2nd global loop many-cell systems. & Controller, Map Array, Reduce loop, Scan loop & MapScanReduce Parallel Accelerator \\ \hline
