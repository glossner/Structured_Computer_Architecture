...
\begin{problem}
Let us consider a $p$-input scan network with cells defined on two 34-bit inputs, {\tt in1} and {\tt in2}, and two 34-bit outputs, {\tt out1} and {\tt out2}, synchronized by the clock signal. Design a $p$-input scan network and implement it for $p=16$ in a version independent of the actual content of the cells, i.e., consider only the top level of the design. The pattern of a scan network is exemplified in Figure \ref{red}.
