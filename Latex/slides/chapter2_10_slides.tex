...
\begin{itemize}
\item \concept{Formal Definition}: Mathematical model of computation
\begin{itemize}
\item Set of states
\item Input alphabet
...
\end{itemize}
\vspace{0.5cm}
\item \concept{Two Main Categories}:
\begin{itemize}
...
\end{itemize}
\vspace{0.3cm}
\item \concept{Computational Power}:
\begin{itemize}
...
\begin{itemize}
\item \concept{Graphical Representation}:
\begin{itemize}
...
\end{enumerate}
\vspace{0.3cm}
\item \concept{Analysis Techniques}:
\begin{itemize}
