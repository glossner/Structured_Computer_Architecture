...
\begin{itemize}
\item \concept{Latch Function}: Store temporary signal transitions
\begin{itemize}
...
\begin{itemize}
\item \concept{Design Solution}: Add clock conditioning
\begin{itemize}
...
\begin{itemize}
\item \concept{Motivation}: Eliminate forbidden state of SR latch
\begin{itemize}
...
\begin{itemize}
\item \concept{Structure}: Two latches in series
\begin{itemize}
...
\begin{itemize}
\item \concept{Definition}: Random Access Memory
\begin{itemize}
...
\end{itemize}
\vspace{0.3cm}
\item \concept{Critical Timing Parameters}:
\begin{itemize}
...
\begin{itemize}
\item \concept{Word-Oriented Memory}:
\begin{itemize}
...
\begin{itemize}
\item \concept{Motivation}: High-speed operation challenges
\begin{itemize}
...
\end{itemize}
\vspace{0.5cm}
\item \concept{Synchronous Solution}:
\begin{itemize}
...
\begin{itemize}
\item \concept{Definition}: Battery of registers with multiple access ports
\begin{itemize}
...
\end{itemize}
\vspace{0.5cm}
\item \concept{Typical Configuration}:
\begin{itemize}
